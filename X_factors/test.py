...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    #factor_list = ['alpha51', 'alpha163', 'alpha180', 'NetAssetPS', 'NPToTOR_j', 'VROC6_j']
    factor_list  = ['AR_60','BB','BBR_20','BM','HLV','NP_220','VOL_R','VOL_T', 'VDC_60', 'SDVC_90', 'SDOC_120']
...
from Tamplate import AR_60,BB,BBR_20,BM,HLV,NP_220,VDC_60,VOL_R,VOL_T,SDVC_90,SDOC_120

for f in ['AR_60','BB','BBR_20','BM','HLV','NP_220','VOL_R','VOL_T', 'VDC_60', 'SDVC_90', 'SDOC_120']:
