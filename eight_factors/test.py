...
from Tamplate import VROC6_j, alpha180, alpha51, alpha163, alpha181, NPToTOR_j, NetAssetPS, TR60

for f in ['VROC6_j', 'alpha180', 'alpha51', 'alpha163', 'alpha181', 'NPToTOR_j', 'NetAssetPS', 'TR60']:
